...
var madison = [{
	...
	items: [{
		...
		name: 'The Robin Room',
		description: 'Just really good cocktails.',
		link: 'http://www.robinroombar.com/',
		picture: "images.jpg",
		map: 'https://goo.gl/maps/SUDv7FBSLap'
   }]
}, {
	category: 'Outdoors',
	items: [{
		name: 'Devil\'s Lake State Park',
		description: 'A gorgeous lake with several hiking trails - also where our engagement photos were taken!',
		link: 'https://www.devilslakewisconsin.com/',
		picture: "images.jpg",
		map: 'https://goo.gl/maps/nVkFQgUe29T2'
   }]
}, {
   category: "Other?",
   items: [{
      name: 'Let us know!',
      description: 'Madison\'s got much more than a city this size has any right to. If you let us know what kind of food or drinks, or museums or attractions you like, we can recommend something just for you!',
}]}];
